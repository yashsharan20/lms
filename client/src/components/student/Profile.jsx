...
const Profile = () => {
    ...
    },[updateUserData,updateUserIsLoading,isSuccess,isError]);
        ...
        <div className="max-w-4xl mx-auto px-4 my-10">
            ...
            <div className="flex flex-col md:flex-row items-center md:items-start gap-8 my-5">
                <div className="flex flex-col items-center">
                    <Avatar className="h-24 w-24 md:h-30 md:w-30 mb-4">
                ...
                <div>
                    ...
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button size="sm" className={'mt-2 ms-2 cursor-pointer'}>Edit Profile</Button>
                        </DialogTrigger>
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>
                            ...
                            <DialogFooter>
                                <Button onClick={updateUserHandler} className="cursor-pointer" disabled={updateUserIsLoading}>
                                    {
                                        updateUserIsLoading ? (
                                            <>
